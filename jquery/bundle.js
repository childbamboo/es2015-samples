...
var hogeStream = _rx2.default.Observable.fromEvent((0, _jquery2.default)('#execute'), 'click').flatMap(function () {
  // Qiitaの新着投稿１０件を取得
  var promise = _jquery2.default.ajax('http://qiita.com/api/v1/items?per_page=10');
  return _rx2.default.Observable.fromPromise(promise);
});

// stream の購読
hogeStream.subscribe(function (res) {
  // 結果(複数件)に対して１件づつ処理
